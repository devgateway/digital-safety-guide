        ...
        <div className="container animate-fade-in" style={{ padding: '2rem 1rem' }}>
            <div className="text-center mb-5">
                ...
                <p className="text-muted" style={{ maxWidth: '800px', margin: '0 auto', fontSize: '1.1rem', lineHeight: '1.7' }}>
                    Gabay Tech is a specialized digital resource <strong>custom-built for the Philippines</strong> to bridge the gap between feeling unsafe online and taking effective action. Developed as part of the National Models for Women's Safety Online (NMWSO) initiative by IREX and Development Gateway: An IREX Venture, this platform provides a proactive, survivor-centered pathway to digital security. <a href="https://www.irex.org/project/national-models-womens-safety-online-nmwso" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline' }}>Learn more about the NMWSO program here</a>.
                </p>
            </div>
